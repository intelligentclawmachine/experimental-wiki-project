...
**Topic: What are the trends and components of a meaningful life?**

## Sources

- [Harvard Study of Adult Development](sources/harvard-study-of-adult-development.md) — 85-year longitudinal study; relationships as #1 predictor
- [Greater Good Top 10 Insights 2025](sources/greater-good-insights-2025.md) — Hope predicts meaning; trust, morality, companionship
- [Greater Good Top 10 Insights 2024](sources/greater-good-insights-2024.md) — Indigenous satisfaction, empathy, self-compassion, biodiversity
- [Pew: What Makes Life Meaningful](sources/pew-what-makes-life-meaningful.md) — 18,850 adults, 17 countries; family dominates
- [Hope as a Meaningful Emotion](sources/hope-meaning-missouri.md) — Hope uniquely predicts meaning (Missouri/Duke)
- [Psychological Richness](sources/psychological-richness.md) — Third well-being dimension (Westgate & Oishi)
- [Gottman: Trust and Relationships](sources/gottman-trust-and-relationships.md) — Bids, Four Horsemen, ATTUNE, 5:1 ratio
- [Attachment Theory in Adult Relationships](sources/attachment-theory-adult-relationships.md) — Four styles, earned security
- [Brené Brown: Anatomy of Trust](sources/brene-brown-anatomy-of-trust.md) — BRAVING, vulnerability, self-trust as foundation
...
- [George Vaillant](entities/george-vaillant.md) — Harvard Study director; five lessons, coping/defense hierarchy
- [Robert Waldinger](entities/robert-waldinger.md) — Current Harvard Study director; relationships as central finding
- [Laura King](entities/laura-king.md) — Mizzou professor; hope-meaning research
- [Erin Westgate](entities/erin-westgate.md) — UF psychologist; psychological richness
- [Shigehiro Oishi](entities/shigehiro-oishi.md) — UChicago psychologist; psychological richness
...
- [Relationships](concepts/relationships.md) — Dominant predictor; how they work and how to build them
- [Trust](concepts/trust.md) — Interpersonal and intrapersonal; Gottman/Brown/meta-analytic frameworks
- [Self-Trust](concepts/self-trust.md) — Foundation of all trust; BRAVING inward
- [Vulnerability](concepts/vulnerability.md) — Gateway to connection; trust-vulnerability loop
- [Attachment Theory](concepts/attachment-theory.md) — Four styles, earned security
- [Hope](concepts/hope.md) — Only positive emotion consistently predicting meaning
- [Mature Coping Mechanisms](concepts/mature-coping-mechanisms.md) — Vaillant's adaptive hierarchy
- [Psychological Richness](concepts/psychological-richness.md) — Third well-being dimension
